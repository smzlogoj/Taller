...
Vamos a realizar un análisis de expresíon diferencial  con el conjunto de datos *modencodefly* de la Drosophila melanogaster.
...
#| echo: true
#| output-location: fragment
head(names(df) %in% df.fenotipos$sample.id, 15)
```
. . .
```{r}
#| echo: true
...
res <- lfcShrink(dds, coef="stage_L2Larvae_vs_L1Larvae", type="apeglm")
